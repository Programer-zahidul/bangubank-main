              ...
              <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <ul role="list" class="divide-y divide-gray-100">
                  ...
                  if (!empty($user_list)) {
                          ...
                          <div class="flex gap-x-4">
                            ...
                            <div class="flex-auto min-w-0">
                              ...
                              <p class="flex mt-1 text-xs leading-5 text-gray-500">
                                <a href="./customer_transactions.php"
                                  class="relative truncate hover:underline"><?php echo $u_data[1] ?></a>
                              </p>
                            </div>
                    ...
                    ?>
                    <li class="relative flex justify-center px-4 py-5 gap-x-6 hover:bg-gray-50 sm:px-6 lg:px-8">
                      <div class="flex content-center text-center gap-x-4">
                        <p class="text-xl text-center font-semibold leading-6 text-gray-900">No User Found!
                        </p>
                      </div>
                    </li>
                    <?php
                  ...
                  <!-- <li class="relative flex justify-between px-4 py-5 gap-x-6 hover:bg-gray-50 sm:px-6 lg:px-8">
                    <div class="flex gap-x-4">
                      ...
                      <div class="flex-auto min-w-0">
                        ...
                        <p class="flex mt-1 text-xs leading-5 text-gray-500">
                          <a href="./customer_transactions.php"
                            class="relative truncate hover:underline">muntaser@muttaqi.com</a>
                        </p>
                      </div>
                    </div>
                  </li> -->
